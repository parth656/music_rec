...
def feed():
    ...
    return render_template("feed_ideas.html", sorted_array=display_data, txt=message)
...
def discover():
    ...
    return render_template("discover_ideas.html", sorted_array=placeholder, txt=message)
